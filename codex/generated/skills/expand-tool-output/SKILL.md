...
This skill can read existing Claude archive IDs only when the local Claude archive helper is installed. It does not enable a Codex compaction hook. If the archive/helper is unavailable, report the missing dependency instead of guessing output.
